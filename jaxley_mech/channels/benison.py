...
class Leak(Channel):
    ...
    def compute_current(
        ...
        prefix = self._name
        gLeak = params[f"{prefix}_gLeak"] * 1000  # m/cm^2
...
class Na(Channel):
    ...
    def compute_current(
        ...
        prefix = self._name
        m, h = states[f"{prefix}_m"], states[f"{prefix}_h"]
        gNa = params[f"{prefix}_gNa"] * (m**3) * h * 1000  # m/cm^2
...
class Kdr(Channel):
    ...
    def compute_current(
        ...
        # Multiply with 1000 to convert Siemens to milli Siemens.
        gKdr = params[f"{prefix}_gKdr"] * (m**3) * 1000  # m/cm^2
...
class KA(Channel):
    ...
    def compute_current(
        ...
        prefix = self._name
        m, h = states[f"{prefix}_m"], states[f"{prefix}_h"]
        gKA = params[f"{prefix}_gKA"] * (m**3) * h * 1000  # m/cm^2
...
class CaL(Channel):
    ...
    def compute_current(
        ...
        prefix = self._name
        m = states[f"{prefix}_m"]
        gCaL = params[f"{prefix}_gCaL"] * (m**2) * 1000  # m/cm^2
...
class CaN(Channel):
    ...
    def compute_current(
        ...
        prefix = self._name
        m, h = states[f"{prefix}_m"], states[f"{prefix}_h"]
        gCaN = params[f"{prefix}_gCaN"] * (m**2) * h * 1000  # m/cm^2
...
class KCa(Channel):
    ...
    def compute_current(
        ...
        gKCa = params[f"{prefix}_gKCa"] * (C**4 / (C**4 + K_KCa**4)) * 1000  # m/cm^2
